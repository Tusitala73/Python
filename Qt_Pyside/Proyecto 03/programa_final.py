...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        conexion = QSqlDatabase.addDatabase("QSQLITE")  # indica el tipo de base de datos
        conexion.setDatabaseName(absPath("contactos.db"))  # dice a que base de datos conectar
